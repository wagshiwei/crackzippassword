  ...
  */
  ...
  else if (isExtractGroupCommand || options.Command.CommandType == NCommandType::kList)
  {
    ...
    if (isExtractGroupCommand)
    {
	  ...
	  ecs->PasswordIsDefinedForced = options.PasswordEnableForced;
	  ecs->PasswordDict = options.PasswordForcedDict;
      #endif
  ...
  else if (options.Command.IsFromUpdateGroup())
  {
    ...
    openCallback.Password = options.Password;
	openCallback.PasswordIsDefinedForced = options.PasswordEnableForced;
	openCallback.PasswordDict = options.PasswordForcedDict;
    #endif
